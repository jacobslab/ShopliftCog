...
BEFORE RUNNING THE ASSET PACK MAKE SURE:
...
Lens Flares - not required

Assign the MainCamera to RigidbodyFPSController at the Cam slot.

You can also use Package Manager to include the Post Processing Stack (latest version) - not required
Currently Post Processing Stack for 2018.3 is in Preview status. There are problems with the use of it and it is not used in the pack. You can experiment freely by using it.

If you decide to use it make sure the MainCamera is on a the layer PostProcessing and also that the Post Processing Stack scripts work on that layer. This is the correct way to set it up in Unity 2018.3
